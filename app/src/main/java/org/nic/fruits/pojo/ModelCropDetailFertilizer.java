...
@Entity(tableName="cropdetailfertilizer")
public class ModelCropDetailFertilizer {
    ...
    @Ignore
    public ModelCropDetailFertilizer(int id, String feid, String fertilizername, String fertilizekname, String fertilizertype, String fertilizernitrogen, String fertilizerphosphorous, String fertilizerpotash, String fertilizernutrient) {
        this.id = id;
        this.feid = feid;
    ...
    public ModelCropDetailFertilizer(String feid, String fertilizername, String fertilizekname, String fertilizertype, String fertilizernitrogen, String fertilizerphosphorous, String fertilizerpotash, String fertilizernutrient) {
        this.feid = feid;
        this.fertilizername = fertilizername;
        this.fertilizekname = fertilizekname;
        this.fertilizertype = fertilizertype;
